...
using Diyan.Application.Constants;
...
namespace Diyan.API.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public async Task<ResponseModel> MobileAppLogin(MobileAppLoginRequestModel parameters)
        {
            ...
            MobileAppLoginSessionData? loginResponse;
            UserLoginHistorySaveParameters loginHistoryParameters;

            loginResponse = await _loginRepository.ValidateMobileAppLogin(parameters);
            if (loginResponse != null)
            {
                tokenResponse = _jwt.GenerateJwtToken_Customer(loginResponse);
                ...
                if (loginResponse.UserId != null)
                {
                    customerSessionData = new SessionDataCustomer
                    {
                        ...
                        LeadStatusId = loginResponse.LeadStatusId,
                        LeadStatus = loginResponse.LeadStatus,
