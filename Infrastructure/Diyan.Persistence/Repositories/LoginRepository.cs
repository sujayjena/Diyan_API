...
namespace Diyan.Persistence.Repositories
{
    public class LoginRepository : GenericRepository, ILoginRepository
    {
        ...
        public async Task<MobileAppLoginSessionData?> ValidateMobileAppLogin(MobileAppLoginRequestModel parameters)
        {
            IEnumerable<MobileAppLoginSessionData> lstResponse;
            ...
            lstResponse = await ListByStoredProcedure<MobileAppLoginSessionData>("ValidateMobileAppLogin", queryParameters);
        ...
        public async Task<MobileAppLoginSessionData?> GetCustomerDetailsByToken(string token)
        {
            IEnumerable<MobileAppLoginSessionData> lstResponse;
            DynamicParameters queryParameters = new DynamicParameters();
            queryParameters.Add("@Token", token);
            lstResponse = await ListByStoredProcedure<MobileAppLoginSessionData>("GetCustomerDetailsByToken", queryParameters);
